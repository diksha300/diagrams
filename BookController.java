...
public class BookController {
 ...
 { 
	...
	//   System.out.println(app.getString(1));
		...
		System.out.println("app.ne while");
	    while(app.next()){
	    	System.out.println("inside while");
		   Flight f=new Flight();
		   f.setF_id(app.getInt(1));
		   f.setArr_date(app.getString(2));
		   f.setDep_time(app.getString(3));
		   f.setDep_date(app.getString(4));
		   f.setClass_type(app.getString(5));
		   f.setFrom_loc(app.getString(6));
		   f.setTo_loc(app.getString(7));
		   f.setArr_time(app.getString(8));
		   f.setF_name(app.getString(11));
		   f.setF_amt(app.getString(12));
		   listFlights.add(f);
