...
<font color="white">
<h4>AirPath collects information from a large number of sources (airlines, airports and others) and presents an intuitive display of the data we compile. Registered users can explore details collected from the data sources. For more information, see an in-depth explanation below. In summary FlightStats:</h4>
<h4>Tracks flight status in near real-time</h4>
<h4>Has global coverage</h4>
<h4>Links airport delay information to the affected flight</h4>
<h4>Stores information historically and calculates on-time performance rating for flights and airlines</h4>
</font>
